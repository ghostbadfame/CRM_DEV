...
import { EmployeeCompactData, MarketingEmployeeCompactData } from "@/lib/utils";
...
export type ClientEmployee = MarketingEmployeeCompactData;

export const marketingEmpTableCol: ColumnDef<ClientEmployee>[] = [
  {
    accessorKey: "empNo",
    header: ({ column }) => {
      return (
